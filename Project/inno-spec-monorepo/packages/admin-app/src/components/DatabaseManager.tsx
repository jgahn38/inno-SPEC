            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3 mb-4">
                ...
                <select
                  ...
                  className="w-full pl-3 pr-8 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none appearance-none bg-[url('data:image/svg+xml;base64,')] bg-[right_0.5rem_center] bg-no-repeat"
                >
        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full pl-3 pr-8 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none appearance-none bg-[url('data:image/svg+xml;base64,')] bg-[right_0.5rem_center] bg-no-repeat"
                >
                  {databaseService.getSupportedCategories().map(category => (
                    <option key={category.value} value={category.value}>
                  ...
                  <div className="mb-6 p-4 bg-gray-50 rounded-md">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-3">
                      ...
                      <select
                        ...
                        className="pl-3 pr-8 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none appearance-none bg-[url('data:image/svg+xml;base64,')] bg-[right_0.5rem_center] bg-no-repeat"
                      >
