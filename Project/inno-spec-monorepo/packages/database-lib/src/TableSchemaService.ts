import { TableSchema, TableField, FieldType, ValidationRule } from '@inno-spec/shared';
...
export class TableSchemaService {
  ...
  // getTableById 별칭 (ScreenRuntimeView에서 사용)
  public getTableById(tableId: string): TableSchema | undefined {
    return this.getSchema(tableId);
  }
  ...
  public getSupportedFieldTypes(): FieldType[] {
    return ['text', 'number', 'date', 'boolean', 'decimal', 'integer', 'list'];
  }
