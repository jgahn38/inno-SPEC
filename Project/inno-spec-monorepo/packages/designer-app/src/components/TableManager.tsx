...
const TableManager: React.FC = () => {
  ...
  // const [selectedDbCategory, setSelectedDbCategory] = useState<DatabaseCategory | ''>(''); // 사용하지 않음
  ...
  const handleDbCategoryChange = (category: DatabaseCategory | '') => {
    // setSelectedDbCategory(category); // 사용하지 않음
    if (category === '') {
  ...
  useEffect(() => {
    ...
    loadFields();
    loadDatabases();
  }, [loadSchemas, loadFields, loadDatabases]);
